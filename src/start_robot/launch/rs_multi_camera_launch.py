...
local_parameters = [{'name': 'camera_name1', 'default': 'left', 'description': 'camera1 unique name'},
                    ...
                    {'name': 'serial_no1', 'default': "'323622271323'", 'description': 'choose device1 by serial number'},
                    {'name': 'serial_no2', 'default': "'315122270868'", 'description': 'choose device2 by serial number'} # camera_1_ID,camera_2_ID換成對應數字
                    ]
